...
public class PlayAgainButton extends Button{
    ...
    public PlayAgainButton(GameScreen gameScreen, World world, float posX, float posY, float width, float height) {
        ...
        setRegion(gameScreen.getAtlas().findRegion("play_again"), 0, 0, (int) (width * FallingMan.PPM), (int) (height * FallingMan.PPM));
        setPosition(posX, posY);
    }

    @Override
    public void touched() {
        setRegion(gameScreen.getAtlas().findRegion("play_again_clicked"), 0, 0, (int) (width * FallingMan.PPM), (int) (height * FallingMan.PPM));
        clicked = true;
    }
